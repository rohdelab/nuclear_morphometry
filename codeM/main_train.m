...
for i_tag=TagVec
    ...
    for foldset=1:Nfold
        ...
        if reg_str_both==1
            ...
            %             [PLDA_directions,projPLDA_tr,viz_plda]=PCA_ModesL(xx_tr,lab_tr,p_wt_tr,Ndir,xxT,pT,labT); % PCA_directions,projPCA_tr,viz_plda
    ...
    close(wh);
    d=sprintf(['\nFinished ' Exp_str '-train on Data' num2str(tag) 'ab' '__: loaded lotp space data; performed PLDA on training data; saved PLDA directions, training data projections on the directions, and visualization axis.\n\n']); disp(d);
end
