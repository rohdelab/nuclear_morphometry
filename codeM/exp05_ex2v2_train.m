...
for i_tag=TagVec
    ...
    logpth=[pwd '/RESULTS/EXP05_ex2v2/log'];
    ...
    Exp_str = 'Exp05_ex2v2'; Exp_strF = '/EXP05_ex2v2/';
    cd(p0);
    ...
    for foldset=1:Nfold
        ...
        if force_run|ISthere1==0|ISthere2==0|ISthere3==0
            ...
            [PLDA_directions,projPLDA_tr,viz_plda]=cPLDA_ModesL_ex2v2(xx_tr,lab_tr,p_wt_tr,Ndir,xxT,pT,labT,reg_str,size(u,1)/2);
