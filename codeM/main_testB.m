...
for i_tag=TagVec
    ...
    d=sprintf(['\nFinished ' Exp_str '-testB on Data' num2str(tag) '__: projected test data on PLDA directions in LOTP space; saved PLDA projections; saved the plots of the migration of the mean and axis visualization figures; saved the numerical results in excel.\n\n']); disp(d);
end
%%
