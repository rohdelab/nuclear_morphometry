...
for i_tag=TagVec
    ...
    for foldset=1:Nfold
        ...
        if reg_str_both==1
            ...
            if pca_or_plda_in_01==1
                [dir1,proj1,viz1]=scPCA_ModesL_ex1v2_both(xx_tr1,lab_tr1,p_wt_tr1,xx_tr1,lab_tr1,p_wt_tr1,Ndir,xxT1,pT1,labT1,xxT2,pT2,labT2);
                [dir2,proj2,viz2]=scPCA_ModesL_ex1v2_both(xx_tr2,lab_tr2,p_wt_tr2,xx_tr1,lab_tr1,p_wt_tr1,Ndir,xxT2,pT2,labT2,xxT2,pT2,labT2);
            else
                [dir1,proj1,viz1]=scPLDA_ModesL_ex1v2_both(xx_tr1,lab_tr1,p_wt_tr1,xx_tr1,lab_tr1,p_wt_tr1,Ndir,xxT1,pT1,labT1,xxT2,pT2,labT2);
                [dir2,proj2,viz2]=scPLDA_ModesL_ex1v2_both(xx_tr2,lab_tr2,p_wt_tr2,xx_tr1,lab_tr1,p_wt_tr1,Ndir,xxT2,pT2,labT2,xxT2,pT2,labT2);
            end

            for a=1:length(proj1)
                PLDA_directions{a}=[dir1{a} dir2{a}];
                projPLDA_tr{a}=[proj1{a};proj2{a}];
                viz_plda{a}=cat(3,viz1{a},viz2{a});
            end
