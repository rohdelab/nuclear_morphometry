function [cPLDA_directions,cPLDA_projectionsB,viz_plda] = cPLDA_ModesL_ex1(uB,labelB,pt_wtB,ret_dir_num,xxT,pT,lT)
...
switch alt
    case 1
        ...
        sel_dir=cPLDA_dir(:,1);
%         tmp = size_direction( 1,'TOF',500,21); tmp=tmp/norm(tmp); %tmp=0.00001*tmp;
