...
Ndir=10; Nfold=2;
which_axis=[1:4]; % entries must be <= Ndir, for testA only
...
%                 };
    ...
    for foldset=1:Nfold
        vnm1=[Exp_str '_data' num2str(tr_tag) tr_subtag{1} tr_subtag{2} '_reg' 'TOFnTSOF' '___fold' num2str(foldset) 'of' num2str(Nfold) '_retdir' num2str(Ndir) '_PLDA_directions'];
        vnm2=[Exp_str '_data' num2str(tr_tag) tr_subtag{1} tr_subtag{2} '_reg' 'TOFnTSOF' '___fold' num2str(foldset) 'of' num2str(Nfold) '_retdir' num2str(Ndir) '_projPLDA_tr'];
        vnm3=[Exp_str '_data' num2str(tr_tag) tr_subtag{1} tr_subtag{2} '_reg' 'TOFnTSOF' '___fold' num2str(foldset) 'of' num2str(Nfold) '_retdir' num2str(Ndir) '_viz_plda'];
