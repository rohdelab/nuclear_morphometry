function [cPLDA_directions,cPLDA_projectionsB,viz_plda] = cPLDA_ModesL_pxA(uB,labelB,pt_wtB,ret_dir_num,xxT,pT,lT,reg_str,Nms)
...
%%
dir_num=ret_dir_num+1;% min(size(cPLDA_dir,2),2);
