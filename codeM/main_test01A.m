    ...
    for foldset=1:Nfold
        ...
        if ISthere1==0|ISthere2==0|ISthere3==0
            ...
            for a=1:length(ote)
                ...
                [projPLDA_te,f01,f02,~]=proj_n_plot_PLDAl(xx_tr,lab_tr,xx_te,lab_te,PLDA_directions{a},viz_plda{a},which_axis);
                ...
                if reg_str_both==1
                    tmp_nm1=[str_save_dir(2:end) 'Feat1_test' '_data' ote{a} '_reg' 'BOTH' '___fold' num2str(foldset) 'of' num2str(Nfold) '_retdir' num2str(Ndir)];
                    tmp_nm2=[str_save_dir(2:end) 'Feat2_test' '_data' ote{a} '_reg' 'BOTH' '___fold' num2str(foldset) 'of' num2str(Nfold) '_retdir' num2str(Ndir)];
                    tmp_nm3=[str_save_dir(2:end) 'Feat3_test' '_data' ote{a} '_reg' 'BOTH' '___fold' num2str(foldset) 'of' num2str(Nfold) '_retdir' num2str(Ndir)];
                else
                ...
                saveas(f01,[respth '/' nme '/test01A' str_save_dir '/f1_' otnme{a} '_ax' num2str(which_axis(1)) '_set' num2str(foldset) '_' reg_str '.png']);
                saveas(f02,[respth '/' nme '/test01A' str_save_dir '/f2_' otnme{a} '_ax' num2str(which_axis(1)) '_' num2str(which_axis(2)) '_set' num2str(foldset) '_' reg_str '.png']);
                pause(1); close all;
            end
            disp(' ');
        end
